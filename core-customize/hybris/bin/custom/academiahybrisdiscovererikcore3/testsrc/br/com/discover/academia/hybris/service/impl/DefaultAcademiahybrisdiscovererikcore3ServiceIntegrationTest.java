...
import br.com.discover.academia.hybris.service.impl.DefaultAcademiahybrisdiscovererikcore3Service;
 ...
 */
@IntegrationTest
public class DefaultAcademiahybrisdiscovererikcore3ServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "academiahybrisdiscovererikcore3PlatformLogo";

		// when
		final String logoUrl = academiahybrisdiscovererikcore3Service.getHybrisLogoUrl(logoCode);

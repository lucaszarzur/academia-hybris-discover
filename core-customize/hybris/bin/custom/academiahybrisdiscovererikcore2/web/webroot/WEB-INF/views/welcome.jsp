...
<html>
<head>
    <title>Welcome to academiahybrisdiscovererikcore2</title>
    <link rel="stylesheet" href="<c:url value="/static/academiahybrisdiscovererikcore2-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "academiahybrisdiscovererikcore2" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><strong>resources/academiahybrisdiscovererikcore2-items.xml</strong> - here you can model your items</li>
            <li><strong>resources/academiahybrisdiscovererikcore2-spring.xml</strong> - here you can define your services</li>
            <li><strong>web/webroot/WEB-INF/config/academiahybrisdiscovererikcore2-spring-mvc-config.xml</strong> - here is a Spring MVC related
                configuration
            </li>
            <li><strong>web/webroot/WEB-INF/config/academiahybrisdiscovererikcore2-web-app-config.xml</strong> - here you can define web related services,
                facades etc.
            </li>
            <li><strong>web/webroot/WEB-INF/config/academiahybrisdiscovererikcore2-spring-security-config.xml</strong> - here you can configure your Spring Security settings</li>

...
@Controller
public class Academiahybrisdiscovererikcore2HelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", academiahybrisdiscovererikcore2Service.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
